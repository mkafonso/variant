...
import { createSessionPasswordAction } from '../../actions'

type PageProps = {
  locale: string
}

export function LoginAccountForm(props: PageProps) {
  const { locale } = props
  const [state, formAction, isPending] = useActionState(
    createSessionPasswordAction,
